  ...
  <div>
    ...
    <div class="container mx-auto py-5">
      <div class="mx-auto p-6 max-w-4xl">
        <div class="flex flex-col md:flex-row rounded-2xl shadow-lg overflow-hidden bg-gradient-to-r from-zinc-50 to-slate-100 text-zinc-800 dark:from-slate-800 dark:to-zinc-900 dark:text-zinc-50 mb-3">
        ...
        <div class="flex flex-col md:flex-row rounded-2xl shadow-lg overflow-hidden bg-gradient-to-r from-zinc-50 to-slate-100 text-zinc-800 dark:from-slate-800 dark:to-zinc-900 dark:text-zinc-50">
          ...
          <!-- Contenido -->
          <div class="p-6 flex flex-col justify-center">
            <h2 class="text-2xl font-bold mb-4">Apartadock</h2>
            <p class="text-zinc-600 dark:text-zinc-400">
              Plataforma especializada para la administración integral de conjuntos residenciales y edificios en propiedad horizontal (PH). Está diseñada para centralizar en un solo sistema toda la operación administrativa, financiera y de convivencia que hoy suele estar dispersa entre hojas de cálculo, mensajes y procesos manuales.
            </p>
            <div class="mt-4">
              <NuxtLink to="https://github.com/Droni-app/ApartaDock" title="Github repo">
                <DuiAction variant="ghost" size="sm">
                  <i class="mdi mdi-github"/>
                  Github repo
                </DuiAction>
          ...
          <div class="flex-shrink-0">
            <img
              src="~/assets/img/pages/ApartaDock.png"
              alt="Droni-kit | Catálogo de componentes"
              class="w-full md:w-60 h-48 md:h-full object-cover rounded-t-2xl md:rounded-l-2xl md:rounded-tr-none"
            >
          </div>
