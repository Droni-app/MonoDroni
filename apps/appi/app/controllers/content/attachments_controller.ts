...
export default class AttachmentsController {
  /**
   * @index
   * @summary Listar archivos adjuntos del usuario autenticado
   * @paramQuery page - Número de página - @type(number)
   * @paramQuery per_page - Resultados por página (default 10) - @type(number)
   * @responseBody 200 - {"meta": {"total": 5, "perPage": 10, "currentPage": 1, "lastPage": 1}, "data": [{"id": "uuid", "name": "string", "path": "string", "size": 1024, "mime": "image/jpeg", "url": "string", "createdAt": "string"}]}
  ...
  /**
   * @store
   * @summary Subir un archivo adjunto (multipart/form-data)
