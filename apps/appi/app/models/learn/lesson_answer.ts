import { LearnLessonAnswerSchema } from '#database/schema'
import { beforeCreate, belongsTo } from '@adonisjs/lucid/orm'
import type { BelongsTo } from '@adonisjs/lucid/types/relations'
import LearnLesson from '#models/learn/lesson'
import LearnEnrollment from '#models/learn/enrollment'

export default class LearnLessonAnswer extends LearnLessonAnswerSchema {
  ...
  @beforeCreate()
  static assignUuid(answer: LearnLessonAnswer) {
    answer.id = answer.id || crypto.randomUUID()
  }
}
